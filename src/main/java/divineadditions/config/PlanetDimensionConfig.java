...
public class PlanetDimensionConfig {
    @Config.Comment("possible planets configuration")
    public PlanetConfig[] possiblePlanets = Arrays
            .asList(
                    ...
                    new PlanetConfig(Blocks.WATER, Blocks.GLASS, Blocks.GLASS, Blocks.GLASS, 35)
            )
            .toArray(new PlanetConfig[0]);
