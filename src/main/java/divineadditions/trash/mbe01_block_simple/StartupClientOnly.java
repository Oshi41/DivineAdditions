package divineadditions.trash.mbe01_block_simple;
...
public class StartupClientOnly
{
  public static void preInitClientOnly()
  {
    ...
    ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("divineadditions:mbe01_block_simple", "inventory");
