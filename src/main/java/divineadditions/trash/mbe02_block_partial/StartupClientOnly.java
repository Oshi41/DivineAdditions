package divineadditions.trash.mbe02_block_partial;
...
public class StartupClientOnly
{
  public static void preInitClientOnly()
  {
    ...
    ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("divineadditions:mbe02_block_partial", "inventory");
