package divineadditions.trash.mbe03_block_variants;
...
public class StartupClientOnly
{
  public static void preInitClientOnly()
  {
    ...
    ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("divineadditions:mbe03_block_variants_blue", "inventory");
    ...
    itemModelResourceLocation = new ModelResourceLocation("divineadditions:mbe03_block_variants_green", "inventory");
    ModelLoader.setCustomModelResourceLocation(StartupCommon.itemBlockVariants,
                                               BlockVariants.EnumColour.GREEN.getMetadata(), itemModelResourceLocation);


    itemModelResourceLocation = new ModelResourceLocation("divineadditions:mbe03_block_variants_red", "inventory");
    ModelLoader.setCustomModelResourceLocation(StartupCommon.itemBlockVariants,
                                               BlockVariants.EnumColour.RED.getMetadata(), itemModelResourceLocation);

    itemModelResourceLocation = new ModelResourceLocation("divineadditions:mbe03_block_variants_yellow", "inventory");
    ModelLoader.setCustomModelResourceLocation(StartupCommon.itemBlockVariants,
