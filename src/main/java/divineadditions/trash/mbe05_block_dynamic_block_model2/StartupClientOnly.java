  ...
  public static void preInitClientOnly()
  {
    ...
    StateMapperBase ignoreState = new StateMapperBase() {
      ...
      protected ModelResourceLocation getModelResourceLocation(IBlockState iBlockState) {
        return new ModelResourceLocation("divineadditions:mbe05_block_3d_web_statemapper_name");
      }
    };
    ...
    ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("divineadditions:mbe05_block_3d_web", "inventory");
