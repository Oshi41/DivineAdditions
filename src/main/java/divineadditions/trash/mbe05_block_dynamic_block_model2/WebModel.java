package divineadditions.trash.mbe05_block_dynamic_block_model2;
...
public class WebModel implements IModel {
    ...
    public static final ResourceLocation TEXTURE_SHEET = new ResourceLocation("divineadditions:blocks/mbe05_block_3d_web");

    public static final ModelResourceLocation MODEL_CORE = new ModelResourceLocation("divineadditions:mbe05_web_subblocks/mbe05_block_web_core_model");
    public static final ModelResourceLocation MODEL_UP = new ModelResourceLocation("divineadditions:mbe05_web_subblocks/mbe05_block_web_up_model");
    public static final ModelResourceLocation MODEL_DOWN = new ModelResourceLocation("divineadditions:mbe05_web_subblocks/mbe05_block_web_down_model");
    public static final ModelResourceLocation MODEL_NORTH = new ModelResourceLocation("divineadditions:mbe05_web_subblocks/mbe05_block_web_north_model");
    public static final ModelResourceLocation MODEL_SOUTH = new ModelResourceLocation("divineadditions:mbe05_web_subblocks/mbe05_block_web_south_model");
    public static final ModelResourceLocation MODEL_WEST = new ModelResourceLocation("divineadditions:mbe05_web_subblocks/mbe05_block_web_west_model");
    public static final ModelResourceLocation MODEL_EAST = new ModelResourceLocation("divineadditions:mbe05_web_subblocks/mbe05_block_web_east_model");
