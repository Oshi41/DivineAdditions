...
import divineadditions.trash.mbe06_redstone.input.LampColour;
import divineadditions.trash.mbe06_redstone.input_and_output.TileEntityRedstoneMeter;
import divineadditions.trash.mbe06_redstone.input_and_output.TileEntitySpecialRendererRedstoneMeter;
...
public class StartupClientOnly
{
  public static void preInitClientOnly()
  {
    ...
    ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("divineadditions:mbe06_block_redstone_variable_source", "inventory");
    ...
    ModelResourceLocation itemModelResourceLocationB = new ModelResourceLocation("divineadditions:mbe06b_block_redstone_target", "inventory");
    ...
    ModelResourceLocation itemModelResourceLocationC = new ModelResourceLocation("divineadditions:mbe06c_block_redstone_meter", "inventory");
    ...
    ModelResourceLocation itemModelResourceLocationD = new ModelResourceLocation("divineadditions:mbe06d_block_redstone_coloured_lamp", "inventory");
