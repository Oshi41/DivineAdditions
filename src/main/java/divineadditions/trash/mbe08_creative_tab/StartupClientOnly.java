package divineadditions.trash.mbe08_creative_tab;
...
public class StartupClientOnly
{
  public static void preInitClientOnly()
  {
    ...
    ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("divineadditions:mbe08_creative_tab_item", "inventory");
    final int DEFAULT_ITEM_SUBTYPE = 0;
    ModelLoader.setCustomModelResourceLocation(StartupCommon.testItem, DEFAULT_ITEM_SUBTYPE, itemModelResourceLocation);

    itemModelResourceLocation = new ModelResourceLocation("divineadditions:mbe08_creative_tab_block", "inventory");
