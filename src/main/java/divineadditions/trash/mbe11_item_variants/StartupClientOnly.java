...
//    ModelBakery.addVariantName(StartupCommon.itemVariants,  "divineadditions:mbe11_item_variants_0pc",
//            "divineadditions:mbe11_item_variants_25pc",
//            "divineadditions:mbe11_item_variants_50pc",
//            "divineadditions:mbe11_item_variants_75pc",
//            "divineadditions:mbe11_item_variants_100pc"
//    );
    ...
    for (ItemVariants.EnumBottleFullness fullness : ItemVariants.EnumBottleFullness.values()) {
      ...
      ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("divineadditions:" + itemModelName, "inventory");
      // --> eg divineadditions:mbe11_item_variants_0pc, mbe11_item_variants_25pc, etc
