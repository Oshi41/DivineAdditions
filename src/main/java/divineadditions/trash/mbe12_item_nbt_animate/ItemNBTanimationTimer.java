...
public class ItemNBTanimationTimer implements IItemPropertyGetter {
   ...
   * from the json:
      "overrides": [
           { "predicate": { "chargefraction": 0.000 }, "model": "divineadditions:item/mbe12_item_nbt_animate_0" },
           { "predicate": { "chargefraction": 0.001 }, "model": "divineadditions:item/mbe12_item_nbt_animate_1" },
           { "predicate": { "chargefraction": 0.200 }, "model": "divineadditions:item/mbe12_item_nbt_animate_2" },
           { "predicate": { "chargefraction": 0.400 }, "model": "divineadditions:item/mbe12_item_nbt_animate_3" },
           { "predicate": { "chargefraction": 0.600 }, "model": "divineadditions:item/mbe12_item_nbt_animate_4" },
           { "predicate": { "chargefraction": 0.800 }, "model": "divineadditions:item/mbe12_item_nbt_animate_5" }
        ]
   *
   * @param stack
