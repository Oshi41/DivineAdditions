package divineadditions.trash.mbe15_item_dynamic_item_model;
...
public class StartupClientOnly
{
  public static void preInitClientOnly()
  {
    ...
    // "divineadditions:mbe15_item_chessboard#inventory to our SmartChessboardModel instance
    MinecraftForge.EVENT_BUS.register(ModelBakeEventHandlerMBE15.instance);

    // model to be used for rendering this item
    ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("divineadditions:mbe15_item_chessboard", "inventory");
