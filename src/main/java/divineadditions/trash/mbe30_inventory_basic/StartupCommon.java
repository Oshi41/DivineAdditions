package divineadditions.trash.mbe30_inventory_basic;
...
public class StartupCommon
{
	...
	public static void preInitCommon()
	{
		 ...
		 *          tile.divineadditions:mbe_30_inventory_basic.name
		 */
    ...
    ForgeRegistries.ITEMS.register(itemBlockInventoryBasic);
		...
		GameRegistry.registerTileEntity(TileEntityInventoryBasic.class, "divineadditions:mbe30_tile_inventory_basic");
		...
		NetworkRegistry.INSTANCE.registerGuiHandler(DivineAdditions.instance, GuiHandlerRegistry.getInstance());
