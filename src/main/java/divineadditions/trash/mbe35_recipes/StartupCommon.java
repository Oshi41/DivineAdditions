package divineadditions.trash.mbe35_recipes;
...
public class StartupCommon
{
  ...
  public static void initCommon()
  {
    ...
    GameRegistry.addShapedRecipe(new ResourceLocation("divineadditions:mbe35_recipe_ender_eye"), optionalGroup, new ItemStack(Items.ENDER_EYE), new Object[]{
            " D ",
            "DED",
            " D ",
            'D', Items.DIAMOND,
    ...
    GameRegistry.addShapedRecipe(new ResourceLocation("divineadditions:mbe35_recipe_redstone"), optionalGroup, new ItemStack(Items.REDSTONE), new Object[]{
            "RRR",
            "RCR",
            "RRR",
    ...
    GameRegistry.addShapedRecipe(new ResourceLocation("divineadditions:mbe35_recipe_wood_to_iron_sword"), woodSwordGroup, new ItemStack(Items.IRON_SWORD), new Object[]{
            "CIC",
            "CWC",
            "CCC",
            'C', Blocks.COBBLESTONE,
    ...
    GameRegistry.addShapedRecipe(new ResourceLocation("divineadditions:mbe35_recipe_wood_to_gold_sword"), woodSwordGroup, new ItemStack(Items.GOLDEN_SWORD), new Object[]{
            "CIC",
            "CWC",
            "CCC",
            'C', Blocks.COBBLESTONE,
    ...
    GameRegistry.addShapelessRecipe(new ResourceLocation("divineadditions:mbe35_recipe_greendye"), optionalGroup,
    ...
    saplingRecipe.setRegistryName(new ResourceLocation("divineadditions:mbe35_recipe_sapling"));
//    GameRegistry.register(saplingRecipe);
    ...
    unmirroredRecipe.setRegistryName(new ResourceLocation("divineadditions:mbe35_recipe_cauldron"));
