package divineadditions.trash.mbe40_hud_overlay;
...
public class StartupClientOnly
{
  ...
  {
    ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("divineadditions:mbe40_hud_overlay_item", "inventory");
